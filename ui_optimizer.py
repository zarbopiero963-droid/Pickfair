...
class UIOptimizer:
    ...
    def should_update(self, widget: Any, property_name: str, new_value: Any) -> bool:
        """
    ...
    def configure_if_changed(self, widget: Any, **kwargs) -> bool:
        """
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                **self._stats,
                "skip_ratio": (self._stats["skipped_updates"] / max(1, total)) * 100,

...
class TelegramTabUI:
    ...
    def build(self):
        ...
        left_canvas = tk.Canvas(
            left_container, highlightthickness=0, bg=COLORS["bg_dark"]
        )
        ...
        config_frame = ctk.CTkFrame(
            left_frame, fg_color=COLORS["bg_panel"], corner_radius=8
        )
        ...
        ctk.CTkLabel(
            config_frame, text="API ID:", text_color=COLORS["text_secondary"]
        ...
        ctk.CTkLabel(
            config_frame, text="API Hash:", text_color=COLORS["text_secondary"]
        ).pack(anchor=tk.W, padx=10, pady=(5, 0))
        ...
        self.app.tg_auto_bet_var = tk.BooleanVar(
            value=bool(settings.get("auto_bet", 0))
        )
        ctk.CTkCheckBox(
            config_frame,
        ...
        self.app.tg_confirm_var = tk.BooleanVar(
            value=bool(settings.get("require_confirmation", 1))
        )
        ctk.CTkCheckBox(
            config_frame,
        ...
        ctk.CTkLabel(
            auth_frame, text="Codice:", text_color=COLORS["text_secondary"]
        ).pack(side=tk.LEFT)
        ...
        ctk.CTkLabel(auth_frame, text="2FA:", text_color=COLORS["text_secondary"]).pack(
        ...
        self.app.tg_status_label = ctk.CTkLabel(
            config_frame,
            text=f"Stato: {self.app.telegram_status}",
            text_color=COLORS["text_secondary"],
        )
        ...
        self.app.tg_chats_tree = ttk.Treeview(
            chats_frame, columns=columns, show="headings", height=4
        )
        self.app.tg_chats_tree.heading("name", text="Nome Chat")
        self.app.tg_chats_tree.heading("enabled", text="Attivo")
        self.app.tg_chats_tree.column("name", width=200)
        self.app.tg_chats_tree.column("enabled", width=50)
        ...
        self.app.tg_available_status = ctk.CTkLabel(
            avail_btn_frame, text="", text_color=COLORS["text_secondary"]
        )
        ...
        self.app.tg_available_tree.column("name", width=200)
        ...
        self.app.rules_tree = ttk.Treeview(
            rules_tree_container, columns=rules_columns, show="headings", height=6
        )
        ...
        self.app.rules_tree.column("enabled", width=30)
        self.app.rules_tree.column("name", width=120)
        self.app.rules_tree.column("market", width=100)
        self.app.rules_tree.column("pattern", width=150)

        rules_scroll = ttk.Scrollbar(
            rules_tree_container, orient=tk.VERTICAL, command=self.app.rules_tree.yview
        )
        ...
        signals_frame = ctk.CTkFrame(
            right_frame, fg_color=COLORS["bg_panel"], corner_radius=8
        )
        ...
        self.app.tg_signals_tree = ttk.Treeview(
            signals_tree_container, columns=columns, show="headings", height=15
        )
        ...
        self.app.tg_signals_tree.column("data", width=100)
        self.app.tg_signals_tree.column("selezione", width=150)
        self.app.tg_signals_tree.column("tipo", width=50)
        self.app.tg_signals_tree.column("quota", width=60)
        self.app.tg_signals_tree.column("stake", width=60)
        self.app.tg_signals_tree.column("stato", width=80)

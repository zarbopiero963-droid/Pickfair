...
class TelegramTabUI:
    ...
    def build(self):
        ...
        self.app.tg_available_tree = ttk.Treeview(avail_tree_container, columns=avail_columns, show='headings', height=8, selectmode='extended')
        ...
        self.app.rules_tree = ttk.Treeview(rules_tree_container, columns=rules_columns, show='headings', height=6)
        ...
        self.app.tg_signals_tree = ttk.Treeview(signals_tree_container, columns=columns, show='headings', height=15)

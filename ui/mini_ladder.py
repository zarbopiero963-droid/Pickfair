...
Non esegue ordini direttamente. Pubblica soltanto intenti REQ_QUICK_BET sull'EventBus. """
import tkinter as tk from tkinter import messagebox
import customtkinter as ctk
from theme import COLORS
class MiniLadder(ctk.CTkFrame): def init(self, master, app, event_bus, market_data, selection_data, **kwargs): super().init(master, fg_color="transparent", **kwargs)
self.app = app
    self.bus = event_bus

...
class BettingModule:
    ...
    def _on_connected(self):
        ...
        # --- FIX: Innesca il recovery delle Saghe appena si connette ---
    ...
    def _quick_bet(self, selection_id, bet_type):
        ...
        # Spara la richiesta all'EventBus e al RiskMiddleware (FIX TIER-1: REQ_QUICK_BET e payload destrutturato)
        self.bus.publish(
            "REQ_QUICK_BET",
            {
    ...
    def _open_dutching_window(self):
        ...
        open_dutching_window(
            ...
            on_refresh=getattr(self, "_refresh_prices", None),
        )
    ...
    def _place_bets(self):
        ...
        # Invia richiesta validata al RiskMiddleware (FIX TIER-1: REQ_PLACE_DUTCHING)
        self.bus.publish(
            "REQ_PLACE_DUTCHING",
            {
                "market_id": self.current_market["marketId"],
